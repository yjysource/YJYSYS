...
void QextSerialBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QextSerialBase::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QextSerialBase::dsrChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QextSerialBase::staticMetaObject = { {
    &QIODevice::staticMetaObject,
    qt_meta_stringdata_QextSerialBase.data,
    qt_meta_data_QextSerialBase,
    qt_static_metacall,
    nullptr,
    nullptr
} };
